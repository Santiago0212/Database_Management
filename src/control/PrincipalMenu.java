...
public class PrincipalMenu<K extends Comparable<K>, V> implements Initializable{
    ...
    void addData(ActionEvent event) throws IOException {
		...
		loader.setController(new AddWindow<K, V>(this.nameData));
    ...
    void autoGenerate(ActionEvent event) throws IOException {
    	int numAutoGeneData=Integer.parseInt(numDataAutoGeneTF.getText());
    	
    	FXMLLoader loader = new FXMLLoader(Main.class.getResource("../ui/AutoGenerateDataWindow.fxml"));
		loader.setController(new AutoGenerateDataWindow<K, V>(this.nameData,numAutoGeneData));
		Parent parent = (Parent) loader.load();
		Stage stage = new Stage();
		Scene scene = new Scene(parent);
		stage.setTitle("AVL Tree Search");
		...
		disable=true;
		autoGenerateDataBTN.setDisable(disable);
    }
